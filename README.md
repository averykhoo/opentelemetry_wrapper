...
| `OTEL_EXPORTER_PROMETHEUS_ENDPOINT` | An endpoint on which to expose metrics for Prometheus via FastAPI. (E.g. `/mount`) WARNING: this can clash with your fastapi routes                                                           | *NA* (no Prometheus endpoint)                                                               |
