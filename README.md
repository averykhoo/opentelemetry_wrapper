...
| `OTEL_EXPORTER_PROMETHEUS_ENDPOINT` | An endpoint on which to expose metrics for Prometheus via FastAPI. WARNING: this can clash with your fastapi routes                                                                           | `/metrics` (Note: `/metrics` will 307 redirect to `/metrics/`)                              |
